              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    className="bg-white/20 text-white placeholder:text-white/50 border-white/20 focus:border-white focus-visible:ring-white/30"
                  />
                </div>
                ...
                <div className="pt-4">
                  <Button
                    type="submit"
                    className="w-full bg-white text-xc-purple hover:bg-white/90 font-medium py-6"
                    size="lg"
                  >
                    Join Waitlist
                  </Button>
